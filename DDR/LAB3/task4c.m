...
for lam = lambda
    ...
    for it = N
         [resultsPL(it),resultsAPD(it),resultsMPD(it),resultsTT(it)] = simulator3(lam, C, f, P, b);
         [resultsPL2(it),resultsAPD2(it),resultsMPD2(it),resultsTT2(it)] = simulator2(lam, C, f, P, b);
    end
